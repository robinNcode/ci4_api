...
class EmployeeController extends BaseController
{
    ...
    {
        return $this->respond($this->employeeModel->employeeWithDepartments());
    }
    ...
    public function create(): ResponseInterface
    {
        ...
        if($this->employeeModel->insert($employeeInfo)){
    ...
    {
        $employee = $this->employeeModel->employeeWithDepartments($id);
        if($employee){
    ...
    public function update($id = null): ResponseInterface
    {
        ...
        if($this->employeeModel->update($id, $employeeInfo)){
